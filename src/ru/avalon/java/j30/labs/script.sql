...
create table Users
    ...
    constraint fk_role_users foreign key (roles) references Roles(id)
    );
...
create table Orders
    ...
    constraint fk_users_orders foreign key (users)
    references Users(id)
    );
...
insert into Products(code, title, supplier, initial_price, retail_value) values
    ...
    ('20554', 'Central AHU', 2, 10123.34, 12091.65),
    ('88774', 'AC Indoor Unit', 3, 10123.34, 12091.65),
    ('98774', 'AC Outdoor Unit', 3, 10123.34, 12091.65);
